...
PD_Table:
    ...
    %rep 512
    dq addr + 0x83   ; 2-MB Pages Present, RW (maps 0-1GB)
    %assign addr addr + 0x200000
    %endrep

align 4096
PD_Table_1GB:
    %assign addr 0x40000000  ; Start at 1GB
    %rep 512
    dq addr + 0x83   ; 2-MB Pages Present, RW (maps 1-2GB)
    %assign addr addr + 0x200000
    %endrep

align 4096
PD_Table_2GB:
    %assign addr 0x80000000  ; Start at 2GB
    %rep 512
