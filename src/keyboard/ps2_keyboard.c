...
void classic_keyboard_handle_interrupt()
{
    ...
    {
        KEYBOARD_CAPS_LOCK_STATE state = keyboard_get_caps_lock(&classic_keyboard);
        keyboard_set_caps_lock(&classic_keyboard, state == KEYBOARD_CAPS_LOCK_ON ? KEYBOARD_CAPS_LOCK_OFF : KEYBOARD_CAPS_LOCK_ON);
    }
